...
function Start-Process {
    ...
    $mgsLaunches.Add(@{runtime=$env:XR_RUNTIME_JSON; layers=$env:XR_ENABLE_API_LAYERS; paths=$env:XR_API_LAYER_PATH; headless=$env:OPENXR_SIMULATOR_HEADLESS})
...
try {
    ...
    Write-Output 'Headset launcher: simulator isolation, runtime selection, single game launch, unrelated layers, dry run, live-game refusal and failure cleanup passed.'
} finally {
