...
| Binoculars/scopes | Hold left grip + Y for about 0.3 seconds to equip the stereo binoculars in the right hand; a fresh B tap stows them. Left-stick click switches 2×/4×; right-stick click dives; right trigger marks and A clears. Native analysis/intel and per-weapon scopes remain unfinished. |
